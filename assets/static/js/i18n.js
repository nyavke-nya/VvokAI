...
(() => {
    ...
    const RU = {
        ...
        "fighting": "дерётся",
        "regrouping": "к союзнику",
        "moving up": "идёт вперёд",
        "escaping gas": "уходит от газа",
        "Live": "Живой экран",
        "See what the bot sees, with everything it has found drawn on top. Works from anywhere the panel opens, and only runs while you are looking at it.": "Смотри то же, что видит бот, со всеми найденными объектами поверх. Работает откуда угодно и включается только пока ты смотришь.",
        "Start the bot and this becomes a live picture of what it is looking at.": "Запусти бота — и здесь появится живая картинка того, на что он смотрит.",
        "Watch": "Смотреть",
        "Stop": "Остановить",
        "fighting": "дерётся",
        "regrouping": "к союзнику",
