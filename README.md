...
Внутри exe нет ни одной части бота: зависимости весят 3 ГБ, и такой файл распаковывался бы во временную папку при каждом запуске и ловил бы ложные срабатывания антивируса. Вся сборка — это `build_exe.bat` и `launcher.py`, оба лежат рядом: их можно прочитать и собрать самому, и это лучший ответ на «а вдруг это вирус», чем любые обещания.
