...
**Проще.** При создании ключа на [developer.brawlstars.com](https://developer.brawlstars.com)
укажите диапазон `0.0.0.0/0`. Ключ работает откуда угодно, никаких паролей
нигде не лежит.
