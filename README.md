...
Получается **8 МБ**. Положи exe в пустую папку и запусти — он сам поставит Python, скачает проект и зависимости, проверит обновления и откроет окно приложения. Дальше при каждом старте проверяет обновления сам, включая обновление самого себя.
