...
Адрес меняется при каждом запуске и его не стоит показывать. `cloudflared` намеренно не качается сам — программу, которая выставляет твою машину в интернет, ставишь ты, а не апдейтер.
