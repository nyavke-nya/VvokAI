...
`/panel` присылает ссылку на веб-интерфейс (вход по логину, см. выше) — открывается с телефона, **если он в той же Wi-Fi сети**, что и компьютер. Из мобильного интернета не откроется — панель слушает только твою сеть. Если пробрасывать её наружу туннелем, логин теперь хотя бы есть, но адрес всё равно лучше никому не показывать.
