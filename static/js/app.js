...
const SETTINGS_META = {
    general: [
        ...
        { key: "brawl_api_token", label: "Brawl Stars API Token", type: "text", placeholder: "eyJ0eXAiOiJKV1Qi...", help: "Free from developer.brawlstars.com. Log in, open My Account, Create New Key. IMPORTANT: in the Allowed IP Ranges box type 0.0.0.0/0 - otherwise the key only works from the address you are on right now and dies the moment your provider changes it. Paste the whole key here. (Win streaks are not published by the API, so those stay as you set them.)" },
        { key: "brawl_api_email", label: "Developer Portal Email", type: "text", placeholder: "you@example.com", help: "Only needed if your key is tied to one IP address instead of 0.0.0.0/0. With this filled in, the bot logs in and re-issues the key by itself whenever your address changes, rather than quietly losing trophy sync. Leave empty if you used 0.0.0.0/0 - nothing here is needed then." },
        { key: "brawl_api_password", label: "Developer Portal Password", type: "password", placeholder: "Leave empty if your key uses 0.0.0.0/0", help: "The same password you use on developer.brawlstars.com. Stored in cfg/general_config.toml on this machine, never shown back here and never written to logs - but it is a password in a plain file, so prefer the 0.0.0.0/0 key above if that bothers you." },
