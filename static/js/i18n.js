...
(() => {
    ...
    const RU = {
        ...
        "Telegram bot token used for notifications and for remote control. Send /help in your chat with the bot to see the commands. Requires full restart to apply.":
            "Токен телеграм-бота для уведомлений и для управления. Отправь боту /help в личку, чтобы увидеть список команд. Требует полного перезапуска.",
